...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Future<void> _handlePhoneLogin() async {
    ...
    try {
      // Mock login with email format using phone number
      final email = '$cleanNumber@locapro.com';
      final password = cleanNumber; // Using phone number as password for mock data
      
      await ref.read(mockAuthProvider.notifier).signIn(email, password);
